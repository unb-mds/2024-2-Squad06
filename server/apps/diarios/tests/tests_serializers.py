...
from apps.diarios.serializers import (
    FornecedorSerializer,
    ContratacaoSerializer,
    DiarioSerializer,
)
...
class SerializerTestCase(unittest.TestCase):
    def test_fornecedor_serializer(self):
        fornecedor_mock = MagicMock(
            nome="Fornecedor X", cnpj="12.345.678/0001-99", contract_count=5
        )
