# Generated by Django 4.1.13 on 2025-01-19 23:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contratacao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contratacao', to='diarios.contratacao')),
            ],
        ),
        migrations.AddField(
